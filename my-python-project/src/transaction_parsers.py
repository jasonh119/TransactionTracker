...
class StandardCharteredAccountParser(TransactionParser):
    def parse_file(self, file_path):
        ...
        print(f"Processing Standard Chartered file: {file_path}")
...
class StandardCharteredCreditCardParser(TransactionParser):
    def parse_file(self, file_path):
        ...
        print(f"Processing Standard Chartered Credit Card file: {file_path}")
        ...
        print(f"Account Details: {account_name}, {account_number}")
